...
import org.pineconealliance.blog.config.WeiboConfigProperties;
import org.pineconealliance.blog.dto.SocialTokenDTO;
import org.pineconealliance.blog.dto.SocialUserInfoDTO;
import org.pineconealliance.blog.dto.WeiboTokenDTO;
import org.pineconealliance.blog.dto.WeiboUserInfoDTO;
...
import org.pineconealliance.blog.vo.WeiboLoginVO;
...
public class WeiboLoginStrategyImpl extends AbstractSocialLoginStrategyImpl {
    ...
    public SocialUserInfoDTO getSocialUserInfo(SocialTokenDTO socialTokenDTO) {
        ...
        // 获取微博用户信息
        WeiboUserInfoDTO weiboUserInfoDTO = restTemplate.getForObject(weiboConfigProperties.getUserInfoUrl(),
                WeiboUserInfoDTO.class, data);
        // 返回用户信息
    ...
    private WeiboTokenDTO getWeiboToken(WeiboLoginVO weiBoLoginVO) {
        ...
        try {
            return restTemplate.exchange(weiboConfigProperties.getAccessTokenUrl(), HttpMethod.POST, requestEntity,
                    WeiboTokenDTO.class).getBody();
        } catch (Exception e) {
