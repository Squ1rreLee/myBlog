...
import org.pineconealliance.blog.enums.ArticleTypeEnum;
...
import org.pineconealliance.blog.vo.HexoArticleVO;
...
import static org.pineconealliance.blog.constant.HexoConst.*;
                ...
                if (hexoDelimiterCount.get() == HEXO_MAX_DELIMITER_COUNT) {
                    ...
                    if (hexoDelimiterCount.get() == HEXO_MIN_DELIMITER_COUNT) {
                        if (line.startsWith(TITLE_PREFIX)) {
                            ...
                            hexoArticleVO.setCreateTime(LocalDateTime.parse(line.replace(DATE_PREFIX, "").trim(),
                                    formatter));
